...
flowchart TB
  A["01 Prepare Geometry"]
  B["02 Voxelize Build"]
  C["03 Configure Model"]
  D["04 Run Simulation"]
  E["05 Inspect Results"]
  F["06 Calibrate And Reuse"]
  ...
  linkStyle 0,1,2,3,4 stroke:#67e8f9,stroke-width:2px;
  linkStyle 5 stroke:#f97316,stroke-width:2px,stroke-dasharray: 6 4;
```
